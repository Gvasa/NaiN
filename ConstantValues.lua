...
MUTATE_CONNECTIONS_CHANCE = 0.25            -- sannolikhet för att vi skall försöka ändra vikten på en länk --
...
LINK_MUTATION_CHANCE= 2.0                    -- sannolikhet för att en ny länk skall skapas mellan två noder -- 
BIAS_MUTATION_CHANCE= 0.40                   -- sannolikhet för att en länk skall skapas mellan den sista input-noden och en random-nod -- 
NODE_MUTATION_CHANCE =  0.50                   -- sannolikhet för att en länk skall bli två med olika vikter --
