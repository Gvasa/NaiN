...
MUTATE_CONNECTIONS_CHANCE = 0.80            	-- sannolikhet för att vi skall försöka ändra vikten på en länk (0.25)--
...
LINK_MUTATION_CHANCE= 0.05                    	-- sannolikhet för att en ny länk skall skapas mellan två noder (2.0)-- 
BIAS_MUTATION_CHANCE= 0.40                   	-- sannolikhet för att en länk skall skapas mellan den sista input-noden och en random-nod -- 
NODE_MUTATION_CHANCE =  0.03                   	-- sannolikhet för att en länk skall bli två med olika vikter (0.4)--
